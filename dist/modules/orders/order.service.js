...
const createOrder = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        for (const item of data.items) {
            ...
            yield product_model_1.default.findByIdAndUpdate(product._id, { $inc: { stock: -item.quantity } }, { $inc: { sold: item.quantity } });
        }
...
const cancelOrder = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        for (const item of order.items) {
            yield product_model_1.default.findByIdAndUpdate(item.productId, { $inc: { stock: item.quantity } }, { session });
        }
